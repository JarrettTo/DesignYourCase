...
import { Button, Radio, Combobox, InputBase, useCombobox, Input } from '@mantine/core';
...
export default function ProductSelection() {
    ...
    <div className="w-full h-full flex flex-col items-center justify-start">
        <div className="w-full bg-white flex flex-row items-start justify-center">
            ...
            <div className="flex flex-col items-center justify-start mx-16">
                    ...
                    >
                        ...
                        <Combobox.Dropdown>
                            {currentProduct?.brands.map((brand, index) => (
                                <Combobox.Options>
                                    <Combobox.Option value={brand.name} key={index}>
                                        {brand.name}
                                    </Combobox.Option>   
                                </Combobox.Options>
                            ))}
        ...
        <Button className="my-10" variant="gradient" size='xl' radius='xl' gradient={{from: '#FFC3FE', to: '#B5F5FC', deg: 90}}  
            styles={{
                root: {
